...
var EXAMPLE_TYPE = exports.EXAMPLE_TYPE = 'EXAMPLE_TYPE';
...
var load = exports.load = function load() {
    ...
    jQuery('.loadExampleReactAppHere').each(function (i, e) {
        _reactDom2.default.render(_react2.default.createElement(_Root2.default, null), e);
    });
};
...
var _configureStore2 = __webpack_require__(92);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_prop_types__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_prop_types___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_prop_types__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_history_createHashHistory__ = __webpack_require__(55);
...
var _actionCreators = __webpack_require__(91);
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
    return {
        updateExampleProp: function updateExampleProp() {
            var opts = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
            return dispatch((0, _actionCreators.updateExampleProp)(opts));
        }
    };
};
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(29), __webpack_require__(82)(module)))
...
exports.updateExampleProp = undefined;
...
var updateExampleProp = exports.updateExampleProp = function updateExampleProp(_ref) {
    var _ref$exampleProp = _ref.exampleProp,
        exampleProp = _ref$exampleProp === undefined ? '' : _ref$exampleProp;
...
var _apiMiddleware = __webpack_require__(95);
...
var configureStore = exports.configureStore = function configureStore() {
    ...
    //some reducers:
    _reducers.rootReducer // root reducer
    , _reducers.initialState // our initialState
    , (0, _redux.applyMiddleware)(_apiMiddleware2.default));
    return { store: store };
};
...
exports.rootReducer = exports.initialState = undefined;
...
var _exampleReducer = __webpack_require__(94);

var exampleReducer = _interopRequireWildcard(_exampleReducer);
...
var initialState = exports.initialState = {
    ...
    switch (action.type) {
        case types.EXAMPLE_TYPE:
            return { state: state, exampleProp: action.payload };
        default:
            return state;
    }
};
    ...
    return function (next) {
        return function (action) {
            ...
            if (action.meta.type == 'execute_middleware') {
                var fetchData = false;
                var url = '';
                var fetchOptions = Object.assign({}, action.meta);
